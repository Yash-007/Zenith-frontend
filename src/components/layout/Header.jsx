          ...
          <div className="flex items-center">
            <Link to="/" className="flex items-center space-x-2 sm:space-x-3">
              <div className="relative flex items-center justify-center w-8 h-8 sm:w-10 sm:h-10">
                <div className="absolute inset-0 bg-gradient-to-r from-purple-600 to-indigo-600 rounded-lg shadow-lg"></div>
              ...
              <div className="flex flex-col items-start">
                ...
                <span className="text-xs text-gray-500 hidden sm:block">Growth Platform</span>
              </div>
            </Link>
          </div>
