...
export default function RewardsPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      {/* Current Points Card */}
      <div className="bg-gradient-to-br from-purple-500 to-indigo-600 rounded-2xl shadow-xl p-8 mb-12 text-white">
        <div className="flex flex-col md:flex-row items-center justify-between">
          <div>
            <h2 className="text-2xl font-semibold mb-2">Your Current Points</h2>
            <div className="flex items-baseline space-x-2">
              <span className="text-5xl font-bold">{currentUser?.currentPoints || 0}</span>
          ...
          <div className="mt-6 md:mt-0">
            <button
              ...
              className="px-6 py-3 bg-white text-purple-600 rounded-xl font-medium
      ...
      <div className="mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {rewardRules.map((rule, index) => (
            ...
            >
              <div className="text-purple-500 mb-4">{rule.icon}</div>
      ...
      {/* Redemption Rules */}
      <div className="mb-12">
        <h2 className="text-2xl font-bold text-gray-900 mb-6">Redemption Rules</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      ...
      <div>
        ...
        {isLoading ? (
          ...
          <div className="text-center py-12 bg-gray-50 rounded-xl">
            ...
            <p className="text-gray-600">No rewards redeemed yet</p>
          </div>
        ) : (
          <div className="space-y-4">
